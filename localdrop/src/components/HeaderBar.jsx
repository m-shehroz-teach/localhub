...
export default function HeaderBar({ isConnected, deviceName }) {
  const currentHost = window.location.host;

  return (
    <header className="w-full flex items-center justify-between pb-6 flex-shrink-0">
      <div className="flex items-center gap-3">
        {/* Local Host Tag */}
        <div className="bg-[#101622] border border-[#1e293b]/70 px-4 py-1.5 rounded-full text-xs font-mono font-medium text-slate-300">
          IP: {currentHost}
        </div>
